...
/**
 * @brief Static initializer for a struct sensor_dt_spec
 *
 * This returns a static initializer for a struct sensor_dt_spec given a devicetree
 ...
 *
 * @return Static initializer for a struct sensor_dt_spec for the property.
 *
...
/**
 * @brief Static initializer for a struct sensor_dt_spec from a DT_DRV_COMPAT
 *        instance.
 *
